...
.L5597:
	...
	lsl	r0, r1, #0x2
	cmp	r3, r0
	bge	.L5668	@cond_branch
	lsl	r0, r1, #0x1
	cmp	r3, r0
	bgt	.L5675	@cond_branch
	cmp	r3, r1
	bhi	.LCB52471
	b	.L5576	@long jump
.LCB52471:
...
.L5636:
	...
	and	r0, r0, r4
	cmp	r0, #0
	beq	.L5637	@cond_branch
	lsl	r6, r6, #0x1
.L5637:
	mov	r0, #0xd8
	and	r4, r4, r0
	cmp	r4, #0
	beq	.L5638	@cond_branch
	lsl	r0, r6, #0x4
	sub	r0, r0, r6
	mov	r1, #0xa
	bl	__udivsi3
...
.L5640:
	...
	ldrb	r0, [r1]
	cmp	r0, #0xfe
	bhi	.L5639	@cond_branch
	add	r0, r0, #0x1
	strb	r0, [r1]
.L5639:
	cmp	r6, #0xfe
	bls	.L5643	@cond_branch
	mov	r0, #0x0
	mov	r1, #0x4
	bl	BtlController_EmitBallThrowAnim
	ldr	r0, .L5722+0x4
...
.L5651:
	cmp	r4, r5
	bcs	.L5650	@cond_branch
	bl	Random
	lsl	r0, r0, #0x10
	lsr	r0, r0, #0x10
	cmp	r0, r6
	bcc	.L5653	@cond_branch
.L5650:
	mov	r0, #0x0
	add	r1, r4, #0
	bl	BtlController_EmitBallThrowAnim
...
Cmd_givecaughtmon:
	...
	lsl	r0, r0, #0x18
	cmp	r0, #0
	beq	.L5741	@cond_branch
	bl	ShouldShowBoxWasFullMessage
	lsl	r0, r0, #0x18
	lsr	r1, r0, #0x18
	cmp	r1, #0
	bne	.L5742	@cond_branch
	ldr	r0, .L5745+0x8
	strb	r1, [r0, #0x5]
	ldr	r4, .L5745+0xc
	ldr	r0, .L5745+0x10
...
.L5795:
	ldr	r0, [sp, #0x10]
	cmp	r6, r0
	bne	.L5796	@cond_branch
	cmp	r5, r8
	bne	.L5797	@cond_branch
	ldr	r0, .L5816
	b	.L5815
.L5817:
	.align	2, 0
...
.L5796:
	cmp	r6, sl
	bne	.L5802	@cond_branch
	cmp	r5, r8
	bne	.L5803	@cond_branch
	ldr	r0, .L5822
	b	.L5815
.L5823:
	.align	2, 0
...
.L5812:
	...
	ldr	r0, [sp, #0x1c]
	cmp	r5, r0
	ble	.L5795	@cond_branch
.L5790:
	ldr	r6, [sp, #0x18]
	cmp	r6, sl
	ble	.L5791	@cond_branch
.L5789:
	add	sp, sp, #0x20
	pop	{r3, r4, r5}
	mov	r8, r3
...
Cmd_jumpifoppositegenders:
	...
	cmp	r0, #0xfe
	beq	.L5906	@cond_branch
.L5907:
	cmp	r7, #0xfe
	bne	.L5905	@cond_branch
	cmp	r0, #0
	bne	.L5905	@cond_branch
.L5906:
	ldr	r3, .L5909+0xc
...
.L5917:
	...
	and	r0, r0, r1
	cmp	r0, #0
	bne	.L5920	@cond_branch
	add	r0, r2, #0
	bl	GetBattlerAbility
	cmp	r0, #0xd5
	bne	.L5916	@cond_branch
.L5920:
	ldrb	r0, [r4]
	bl	IsBattlerAlive
	cmp	r0, #0
	bne	.L5915	@cond_branch
.L5916:
	ldrb	r0, [r4]
	add	r0, r0, #0x1
	strb	r0, [r4]
...
Cmd_tryworryseed:
	...
	ldrh	r0, [r0, #0x20]
	cmp	r0, #0x79
	beq	.L5935	@cond_branch
	cmp	r0, #0x79
	bgt	.L5938	@cond_branch
	cmp	r0, #0xf
	beq	.L5935	@cond_branch
	cmp	r0, #0x36
	beq	.L5935	@cond_branch
...
.L5967:
	...
	lsl	r0, r0, #0x1
	cmp	r1, r0
	bls	.L5966	@cond_branch
	add	r0, r0, #0xcf
	cmp	r1, r0
	bhi	.L5971	@cond_branch
	mov	r0, #0x96
	b	.L5977
.L5971:
	mov	r0, #0xcf
