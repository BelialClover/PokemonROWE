const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(MINIOR_CORE_RED, gMonShinyPalette_Minior),
    SPECIES_SHINY_PAL(MINIOR_CORE_ORANGE, gMonShinyPalette_Minior),
    SPECIES_SHINY_PAL(MINIOR_CORE_YELLOW, gMonShinyPalette_Minior),
    SPECIES_SHINY_PAL(MINIOR_CORE_GREEN, gMonShinyPalette_Minior),
    SPECIES_SHINY_PAL(MINIOR_CORE_BLUE, gMonShinyPalette_Minior),
    SPECIES_SHINY_PAL(MINIOR_CORE_INDIGO, gMonShinyPalette_Minior),
    SPECIES_SHINY_PAL(MINIOR_CORE_VIOLET, gMonShinyPalette_Minior),
