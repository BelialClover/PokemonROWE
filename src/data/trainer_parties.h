...
static const struct TrainerMonItemCustomMoves sParty_Berke[] = {
    ...
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_SPORE, MOVE_STEALTH_ROCK, MOVE_SPIKES, MOVE_DESTINY_BOND},
    .moves = {MOVE_RETURN, MOVE_STEALTH_ROCK, MOVE_SPIKES, MOVE_DESTINY_BOND}
    },
    {
    .iv = 255,
    .lvl = 1,
    ...
    .postgameheldItem = ITEM_FOCUS_SASH,
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_STICKY_WEB, MOVE_NUZZLE, MOVE_TAUNT, MOVE_WHIRLWIND},
    .moves = {MOVE_RETURN, MOVE_NUZZLE, MOVE_TAUNT, MOVE_WHIRLWIND}
    },
    {
    .iv = 255,
    .lvl = 1,
    ...
    .postgameheldItem = ITEM_FOCUS_SASH,
    .heldItem = ITEM_SITRUS_BERRY,
    .postgamemoves = {MOVE_SEISMIC_TOSS, MOVE_ENDEAVOR, MOVE_PROTECT, MOVE_EXPLOSION},
    .moves = {MOVE_SEISMIC_TOSS, MOVE_ENDEAVOR, MOVE_PROTECT, MOVE_RETURN}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_HI_JUMP_KICK, MOVE_CRUNCH, MOVE_HEAD_SMASH, MOVE_FAKE_OUT}
    },
    {
    .iv = 250,
    .lvl = 62,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_LEAF_BLADE, MOVE_SUCKER_PUNCH, MOVE_X_SCISSOR, MOVE_THROAT_CHOP}
    },
    {
    .iv = 250,
    .lvl = 62,
    ...
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_DARK_PULSE, MOVE_FLAMETHROWER, MOVE_SLUDGE_BOMB, MOVE_EXTRASENSORY}
    },
    {
    .iv = 250,
    .lvl = 62,
    ...
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_LIQUIDATION, MOVE_CRUNCH, MOVE_CLOSE_COMBAT, MOVE_PSYCHIC_FANGS}
    },
    {
    .iv = 250,
    .lvl = 63,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_FOUL_PLAY, MOVE_BRAVE_BIRD, MOVE_TOXIC, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 65,
    ...
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_PLAY_ROUGH, MOVE_SUCKER_PUNCH, MOVE_CLOSE_COMBAT, MOVE_PSYCHO_CUT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .postgamemoves = {MOVE_DYNAMIC_PUNCH, MOVE_SHADOW_PUNCH, MOVE_EARTHQUAKE, MOVE_CLOSE_COMBAT},
    .moves = {MOVE_DYNAMIC_PUNCH, MOVE_SHADOW_PUNCH, MOVE_EARTHQUAKE, MOVE_STONE_EDGE}
    },
    {
    .iv = 250,
    .lvl = 62,
    ...
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_THUNDERBOLT, MOVE_SHADOW_BALL, MOVE_MOONBLAST, MOVE_PERISH_SONG}
    },
    {
    .iv = 250,
    .lvl = 62,
    ...
    .heldItem = ITEM_WHITE_HERB,
    .postgamemoves = {MOVE_FIRE_BLAST, MOVE_SHADOW_BALL, MOVE_ENERGY_BALL, MOVE_DARK_PULSE},
    .moves = {MOVE_OVERHEAT, MOVE_SHADOW_BALL, MOVE_ENERGY_BALL, MOVE_DARK_PULSE}
    },
    {
    .iv = 250,
    .lvl = 63,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_SHADOW_PUNCH, MOVE_SHADOW_SNEAK, MOVE_DRAIN_PUNCH, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 65,
    ...
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_SHADOW_SNEAK, MOVE_SUCKER_PUNCH, MOVE_PHANTOM_FORCE, MOVE_GUNK_SHOT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_AURORA_VEIL, MOVE_WOOD_HAMMER, MOVE_ROCK_SLIDE, MOVE_ICE_PUNCH}
    },
    {
    .iv = 250,
    .lvl = 62,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_ICICLE_CRASH, MOVE_AQUA_JET, MOVE_PLAY_ROUGH, MOVE_CLOSE_COMBAT}
    },
    {
    .iv = 250,
    .lvl = 62,
    ...
    .heldItem = ITEM_POWER_HERB,
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_SOLAR_BEAM, MOVE_BLIZZARD, MOVE_WATER_PULSE, MOVE_FLASH_CANNON}
    },
    {
    .iv = 250,
    .lvl = 62,
    ...
    .postgameheldItem = ITEM_NONE,
    .heldItem = ITEM_LEFTOVERS,
    .postgamemoves = {MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_PROTECT, MOVE_FISSURE},
    .moves = {MOVE_SURF, MOVE_BLIZZARD, MOVE_SIGNAL_BEAM, MOVE_EARTH_POWER}
    },
    {
    .iv = 250,
    .lvl = 63,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_ICICLE_CRASH, MOVE_ROCK_SLIDE, MOVE_IRON_HEAD, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 65,
    ...
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_RETURN, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_EXPLOSION}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_EARTHQUAKE, MOVE_FIRE_PUNCH, MOVE_OUTRAGE, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 250,
    .lvl = 62,
    ...
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_SLUDGE_BOMB, MOVE_DRAGON_PULSE, MOVE_FLAMETHROWER, MOVE_SURF}
    },
    {
    .iv = 250,
    .lvl = 62,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_EARTHQUAKE, MOVE_OUTRAGE, MOVE_DRAGON_DANCE, MOVE_GUILLOTINE}
    },
    {
    .iv = 255,
    .lvl = 67,
    ...
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_HYPER_VOICE, MOVE_DRAGON_PULSE, MOVE_FLAMETHROWER, MOVE_HYDRO_PUMP}
    }
};
//LEADERS
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_EXPLOSION, MOVE_STONE_EDGE, MOVE_SUPERPOWER, MOVE_EARTHQUAKE},
    ...
    .postgameheldItem = ITEM_LIFE_ORB,
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_X_SCISSOR, MOVE_ROCK_WRECKER, MOVE_POISON_JAB, MOVE_EARTHQUAKE},
    .moves = {MOVE_ROCK_TOMB, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    ...
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_LIQUIDATION, MOVE_HEAD_SMASH, MOVE_JAW_LOCK, MOVE_MEGAHORN},
    .moves = {MOVE_ROCK_TOMB, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
	{
    .iv = 200,
    ...
    .postgameheldItem = ITEM_FOCUS_SASH,
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_LIQUIDATION, MOVE_STONE_EDGE, MOVE_X_SCISSOR, MOVE_AQUA_JET},
    .moves = {MOVE_ROCK_TOMB, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 200,
    ...
    .postgamemoves = {MOVE_HEAVY_SLAM, MOVE_BODY_PRESS, MOVE_OUTRAGE, MOVE_HEAD_SMASH},
    .moves = {MOVE_ROCK_TOMB, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .postgamemoves = {MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_EARTHQUAKE, MOVE_FIRE_PUNCH},
    .moves = {MOVE_ROCK_TOMB, MOVE_THUNDER_WAVE, MOVE_NONE, MOVE_NONE}
	}
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_CLOSE_COMBAT, MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_POISON_JAB},
    ...
    .postgameheldItem = ITEM_FOCUS_SASH,
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_CLOSE_COMBAT, MOVE_LIQUIDATION, MOVE_REVERSAL, MOVE_SUCKER_PUNCH},
    .moves = {MOVE_BULK_UP, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
	{
    .iv = 200,
    ...
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_DRAIN_PUNCH, MOVE_RETURN, MOVE_STONE_EDGE, MOVE_PROTECT},
    .moves = {MOVE_BULK_UP, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
	{
    .iv = 200,
    ...
    .moves = {MOVE_BULK_UP, MOVE_ROCK_TOMB, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_WILD_CHARGE, MOVE_STOMPING_TANTRUM, MOVE_FLAME_CHARGE, MOVE_HI_JUMP_KICK},
    ...
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_ICE_PUNCH, MOVE_WILD_CHARGE, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE},
    ...
    .postgameheldItem = ITEM_SITRUS_BERRY,
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_WILL_O_WISP, MOVE_VOLT_SWITCH},
    .moves = {MOVE_CHARGE_BEAM, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 200,
    ...
    .postgameheldItem = ITEM_CHOICE_SCARF,
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_ICE_FANG, MOVE_WILD_CHARGE, MOVE_CRUNCH, MOVE_PLAY_ROUGH},
    .moves = {MOVE_CHARGE_BEAM, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 200,
    ...
    .postgamemoves = {MOVE_BOOMBURST, MOVE_SLUDGE_BOMB, MOVE_DISCHARGE, MOVE_NUZZLE},
    .moves = {MOVE_CHARGE_BEAM, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_WILD_CHARGE, MOVE_FLARE_BLITZ, MOVE_PLAY_ROUGH, MOVE_BURN_UP},
    ...
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_POWER_GEM, MOVE_FLAMETHROWER, MOVE_GIGA_DRAIN, MOVE_EARTH_POWER},
    ...
    .postgameheldItem = ITEM_SITRUS_BERRY,
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_GRASS_KNOT, MOVE_FLAMETHROWER, MOVE_BELCH, MOVE_NASTY_PLOT},
    .moves = {MOVE_INCINERATE, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 200,
    ...
    .moves = {MOVE_INCINERATE, MOVE_ATTRACT, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .postgameheldItem = ITEM_ASSAULT_VEST,
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_RETURN, MOVE_THUNDER_FANG, MOVE_PLAY_ROUGH, MOVE_CRUNCH},
    ...
    .postgameheldItem = ITEM_NORMAL_GEM,
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_FAKE_OUT, MOVE_KNOCK_OFF, MOVE_RETURN, MOVE_AERIAL_ACE},
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .heldItem = ITEM_NORMAL_GEM,
	.happiness = 255,
    .postgamemoves = {MOVE_RETURN, MOVE_BRAVE_BIRD, MOVE_HI_JUMP_KICK, MOVE_ROOST},
    ...
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_BRAVE_BIRD, MOVE_ROOST, MOVE_BODY_PRESS, MOVE_IRON_HEAD},
    .moves = {MOVE_AERIAL_ACE, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 200,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .postgameheldItem = ITEM_WEAKNESS_POLICY,
    .heldItem = ITEM_LEFTOVERS,
    .postgamemoves = {MOVE_POWER_GEM, MOVE_MOONBLAST, MOVE_PSYCHIC, MOVE_ICE_BEAM},
    .moves = {MOVE_CALM_MIND, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .postgamemoves = {MOVE_POWER_GEM, MOVE_SOLAR_BEAM, MOVE_PSYSHOCK, MOVE_FIRE_BLAST},
    .moves = {MOVE_CALM_MIND, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .postgameheldItem = ITEM_WHITE_HERB,
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_STONE_EDGE, MOVE_LIQUIDATION, MOVE_POISON_JAB, MOVE_SHELL_SMASH},
    .moves = {MOVE_WATER_PULSE, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 200,
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .postgamemoves = {MOVE_SCALD, MOVE_ICE_BEAM, MOVE_EARTH_POWER, MOVE_PSYCHIC},
    ...
    .postgameheldItem = ITEM_CHOICE_SPECS,
    .heldItem = ITEM_LIFE_ORB,
    .postgamemoves = {MOVE_THUNDER, MOVE_SURF, MOVE_PSYSHOCK, MOVE_ICE_BEAM},
    .moves = {MOVE_THUNDERBOLT, MOVE_SURF, MOVE_PSYSHOCK, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 67,
    ...
    .postgamemoves = {MOVE_AURA_SPHERE, MOVE_ICE_BEAM, MOVE_DRAGON_PULSE, MOVE_SCALD},
    .moves = {MOVE_AURA_SPHERE, MOVE_ICE_BEAM, MOVE_DRAGON_PULSE, MOVE_WATER_PULSE}
    },
    {
    .iv = 255,
    .lvl = 68,
    ...
    .postgameheldItem = ITEM_WACAN_BERRY,
    .heldItem = ITEM_LEFTOVERS,
    .postgamemoves = {MOVE_HURRICANE, MOVE_SCALD, MOVE_ROOST, MOVE_ICE_BEAM},
    .moves = {MOVE_SURF, MOVE_GIGA_DRAIN, MOVE_FOCUS_BLAST, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 70,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .postgamemoves = {MOVE_SCALD, MOVE_DRAGON_PULSE, MOVE_ICE_BEAM, MOVE_MUD_SPORT},
    ...
    .postgamemoves = {MOVE_ICE_PUNCH, MOVE_EARTHQUAKE, MOVE_LIQUIDATION, MOVE_ROCK_SLIDE},
    .moves = {MOVE_ICE_PUNCH, MOVE_EARTHQUAKE, MOVE_LIQUIDATION, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .happiness = 0,
    .species = SPECIES_GALLADE,
    .postgamemoves = {MOVE_CLOSE_COMBAT, MOVE_ZEN_HEADBUTT, MOVE_LEAF_BLADE, MOVE_THUNDER_PUNCH},
...
static const struct TrainerMonNoItemCustomMoves sParty_Gerald[] = {
    ...
    .happiness = 0,
    .species = SPECIES_KECLEON,
    .postgamemoves = {MOVE_FLAMETHROWER, MOVE_FAKE_OUT, MOVE_FAINT_ATTACK, MOVE_BIND},
    .moves = {MOVE_TACKLE, MOVE_FURY_SWIPES, MOVE_FAINT_ATTACK, MOVE_BIND}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR2[] = {
    ...
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_EARTHQUAKE, MOVE_DRAGON_CLAW, MOVE_STONE_EDGE, MOVE_FIRE_FANG}
    },
    {
    .iv = 255,
    .lvl = 60,
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR3[] = {
    ...
    .species = SPECIES_AZUMARILL,
    .postgamemoves = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .moves = {MOVE_AQUA_JET, MOVE_LIQUIDATION, MOVE_PLAY_ROUGH, MOVE_BOUNCE}
    },
    {
    .iv = 200,
    .lvl = 58,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne2[] = {
    ...
    .heldItem = ITEM_AGGRONITE,
    .postgamemoves = {MOVE_HEAVY_SLAM, MOVE_BODY_PRESS, MOVE_OUTRAGE, MOVE_HEAD_SMASH},
    .moves = {MOVE_IRON_HEAD, MOVE_ROCK_TOMB, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 5,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne3[] = {
    ...
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_ICE_BEAM, MOVE_POWER_GEM, MOVE_EARTH_POWER, MOVE_HYDRO_PUMP},
    .moves = {MOVE_ICE_BEAM, MOVE_POWER_GEM, MOVE_EARTH_POWER, MOVE_NONE}
    },
    {
    .iv = 220,
    .lvl = 5,
    ...
    .postgameheldItem = ITEM_SMOOTH_ROCK,
    .heldItem = ITEM_SITRUS_BERRY,
    .postgamemoves = {MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_CRUNCH, MOVE_ICE_PUNCH},
    .moves = {MOVE_CRUNCH, MOVE_EARTHQUAKE, MOVE_IRON_TAIL, MOVE_NONE}
    },
	{
    .iv = 220,
    .lvl = 5,
    ...
    .heldItem = ITEM_AGGRONITE,
    .postgamemoves = {MOVE_HEAVY_SLAM, MOVE_BODY_PRESS, MOVE_OUTRAGE, MOVE_HEAD_SMASH},
    .moves = {MOVE_IRON_HEAD, MOVE_ROCK_SLIDE, MOVE_DRAGON_RUSH, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 5,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne5[] = {
    ...
    .heldItem = ITEM_AGGRONITE,
    .postgamemoves = {MOVE_HEAVY_SLAM, MOVE_BODY_PRESS, MOVE_OUTRAGE, MOVE_HEAD_SMASH},
    .moves = {MOVE_HEAVY_SLAM, MOVE_BODY_PRESS, MOVE_OUTRAGE, MOVE_HEAD_SMASH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery3[] = {
    ...
    .postgameheldItem = ITEM_ROCKY_HELMET,
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_DRAGON_PULSE, MOVE_FLAMETHROWER, MOVE_SOLAR_BEAM, MOVE_BODY_PRESS},
...
static const struct TrainerMonItemCustomMoves sParty_Flannery4[] = {
    ...
    .heldItem = ITEM_LIFE_ORB,
    .postgamemoves = {MOVE_EARTHQUAKE, MOVE_SHADOW_BONE, MOVE_STONE_EDGE, MOVE_FLARE_BLITZ},
    .moves = {MOVE_EARTHQUAKE, MOVE_SHADOW_BONE, MOVE_STONE_EDGE, MOVE_NONE}
    },
    {
    .iv = 200,
    .lvl = 5,
...
static const struct TrainerMonItemCustomMoves sParty_Norman2[] = {
    ...
    .postgameheldItem = ITEM_SITRUS_BERRY,
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_BELLY_DRUM, MOVE_EXTREME_SPEED, MOVE_PLAY_ROUGH, MOVE_CRUNCH},
    .moves = {MOVE_RETURN, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 200,
...
static const struct TrainerMonItemCustomMoves sParty_Winona5[] = {
    ...
    .heldItem = ITEM_NORMAL_GEM,
	.happiness = 255,
    .postgamemoves = {MOVE_ROOST, MOVE_BRAVE_BIRD, MOVE_PROTECT, MOVE_TOXIC},
    .moves = {MOVE_AERIAL_ACE, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 200,
    ...
    .postgameheldItem = ITEM_LIFE_ORB,
    .heldItem = ITEM_SITRUS_BERRY,
    .postgamemoves = {MOVE_BRAVE_BIRD, MOVE_ROCK_SLIDE, MOVE_ROOST, MOVE_EARTHQUAKE},
    .moves = {MOVE_AERIAL_ACE, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 200,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza2[] = {
    ...
    .postgameheldItem = ITEM_NONE,
    .heldItem = ITEM_POWER_HERB,
    .postgamemoves = {MOVE_PSYSHOCK, MOVE_POWER_GEM, MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM},
    .moves = {MOVE_CALM_MIND, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 255,
    ...
    .happiness = 255,
    .species = SPECIES_LUNATONE,
    .postgameheldItem = ITEM_PETAYA_BERRY,
    .heldItem = ITEM_SITRUS_BERRY,
    .postgamemoves = {MOVE_PSYCHIC, MOVE_POWER_GEM, MOVE_ICE_BEAM, MOVE_MOONBLAST},
    .moves = {MOVE_CALM_MIND, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan2[] = {
    ...
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_MEGAHORN, MOVE_WATERFALL, MOVE_POISON_JAB, MOVE_HORN_DRILL},
    .moves = {MOVE_WATER_PULSE, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 200,
...
static const struct TrainerMonItemCustomMoves sParty_Juan5[] = {
    ...
    .postgameheldItem = ITEM_DAMP_ROCK,
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_SURF, MOVE_HURRICANE, MOVE_U_TURN, MOVE_TAILWIND},
    .moves = {MOVE_WATER_PULSE, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 252,
    ...
    .postgameheldItem = ITEM_LIFE_ORB,
    .heldItem = ITEM_LIFE_ORB,
    .postgamemoves = {MOVE_WATERFALL, MOVE_DRAGON_DANCE, MOVE_ICE_PUNCH, MOVE_EARTHQUAKE},
    .moves = {MOVE_WATERFALL, MOVE_DRAGON_DANCE, MOVE_ICE_PUNCH, MOVE_EARTHQUAKE}
    },
    {
    .iv = 200,
    .lvl = 5,
    ...
    .postgameheldItem = ITEM_ASSAULT_VEST,
    .heldItem = ITEM_NONE,
    .postgamemoves = {MOVE_SCALD, MOVE_GIGA_DRAIN, MOVE_ICE_BEAM, MOVE_FAKE_OUT},
    .moves = {MOVE_WATER_PULSE, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .postgamemoves = {MOVE_DRAGON_PULSE, MOVE_ICE_BEAM, MOVE_SCALD, MOVE_FLASH_CANNON},
    .moves = {MOVE_DRAGON_PULSE, MOVE_ICE_BEAM, MOVE_SCALD, MOVE_FLASH_CANNON}
    },
	{
    .iv = 200,
    .lvl = 5,
...
static const struct TrainerMonItemCustomMoves sParty_Steven[] = {
    ...
    .postgameheldItem = ITEM_SMOOTH_ROCK,
    .heldItem = ITEM_SMOOTH_ROCK,
    .postgamemoves = {MOVE_CRUNCH, MOVE_STONE_EDGE, MOVE_BODY_PRESS, MOVE_IRON_HEAD},
    .moves = {MOVE_CRUNCH, MOVE_STONE_EDGE, MOVE_BODY_PRESS, MOVE_IRON_HEAD}
    },
    {
    .iv = 255,
    .lvl = 75,
    ...
    .postgameheldItem = ITEM_LUM_BERRY,
    .heldItem = ITEM_LUM_BERRY,
    .postgamemoves = {MOVE_FISHIOUS_REND, MOVE_LEECH_LIFE, MOVE_OUTRAGE, MOVE_EARTHQUAKE},
    .moves = {MOVE_HEAD_SMASH, MOVE_EARTHQUAKE, MOVE_IRON_HEAD, MOVE_DRAGON_CLAW}
    },
    {
    .iv = 255,
    .lvl = 75,
    .evs = {0, 252, 252, 0, 0, 252}, 
    .abilityNum = 0,
    .happiness = 0,
    .species = SPECIES_AERODACTYL,
    .postgameheldItem = ITEM_FOCUS_SASH,
    .heldItem = ITEM_FOCUS_SASH,
    .postgamemoves = {MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_DUAL_WINGBEAT, MOVE_HEAD_SMASH},
    .moves = {MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_DUAL_WINGBEAT, MOVE_HEAD_SMASH}
    },
    {
    .iv = 255,
    .lvl = 75,
    ...
    .postgameheldItem = ITEM_LIFE_ORB,
    .heldItem = ITEM_LIFE_ORB,
    .postgamemoves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_X_SCISSOR, MOVE_IRON_HEAD},
    .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_X_SCISSOR, MOVE_IRON_HEAD}
    },
    {
    .iv = 255,
    .lvl = 75,
    ...
    .postgameheldItem = ITEM_WHITE_HERB,
    .heldItem = ITEM_WHITE_HERB,
    .postgamemoves = {MOVE_SUPERPOWER, MOVE_EARTHQUAKE, MOVE_X_SCISSOR, MOVE_STONE_EDGE},
    .moves = {MOVE_SUPERPOWER, MOVE_EARTHQUAKE, MOVE_X_SCISSOR, MOVE_STONE_EDGE}
    },
    {
    .iv = 255,
    .lvl = 80,
    ...
    .postgamemoves = {MOVE_EARTHQUAKE, MOVE_ZEN_HEADBUTT, MOVE_METEOR_MASH, MOVE_ICE_PUNCH},
