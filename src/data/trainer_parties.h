...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .moves = {MOVE_OVERHEAT, MOVE_ATTRACT, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDERBOLT, MOVE_SURF, MOVE_PSYSHOCK, MOVE_SHADOW_BALL}
    },
    {
    .iv = 250,
    .lvl = 67,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_AURA_SPHERE, MOVE_ICE_BEAM, MOVE_DRAGON_PULSE, MOVE_SURF}
    },
    {
    .iv = 250,
    .lvl = 68,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SCALD, MOVE_PROTECT, MOVE_REST, MOVE_SLEEP_TALK}
    },
    {
    .iv = 255,
    .lvl = 73,
