...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_RAPIDASH_GALARIAN] = gMonIcon_Rapidash,
    [SPECIES_SLOWPOKE_GALARIAN] = gMonIcon_Slowpoke,
    [SPECIES_SLOWBRO_GALARIAN] = gMonIcon_Slowbro,
    [SPECIES_FARFETCHD_GALARIAN] = gMonIcon_Farfetchd,
    [SPECIES_WEEZING_GALARIAN] = gMonIcon_Weezing,
    [SPECIES_MR_MIME_GALARIAN] = gMonIcon_Mrmime,
    [SPECIES_ARTICUNO_GALARIAN] = gMonIcon_Articuno,
    [SPECIES_ZAPDOS_GALARIAN] = gMonIcon_Zapdos,
    [SPECIES_MOLTRES_GALARIAN] = gMonIcon_Moltres,
    [SPECIES_SLOWKING_GALARIAN] = gMonIcon_Slowking,
    [SPECIES_CORSOLA_GALARIAN] = gMonIcon_Corsola,
    [SPECIES_ZIGZAGOON_GALARIAN] = gMonIcon_Zigzagoon,
    [SPECIES_LINOONE_GALARIAN] = gMonIcon_Linoone,
    [SPECIES_DARUMAKA_GALARIAN] = gMonIcon_Darumaka,
    [SPECIES_DARMANITAN_GALARIAN] = gMonIcon_Darmanitan,
    [SPECIES_YAMASK_GALARIAN] = gMonIcon_Yamask,
    [SPECIES_STUNFISK_GALARIAN] = gMonIcon_Stunfisk,
